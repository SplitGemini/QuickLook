...
namespace QuickLook.Plugin.FontViewer
{
    public partial class FontViewerPanel : UserControl
    {
        public FontViewerPanel()
        {
            ...
            //edit by gh - add divide line
            //alpha.Inlines.Add(new Run(TranslationHelper.Get("ALPHA")));
            
            alpha.Inlines.Add(new Run(TranslationHelper.Get("DIVIDE",locale:info) + "\n" + TranslationHelper.Get("ALPHA", locale: info)));
            //----------------//
            alpha.Margin = marginbottom;
            //add by gh - larger size
            RichTB.FontSize = 20;
            //----------------//
            ...
            numeric.Inlines.Add(new Run(TranslationHelper.Get("DIGITS", locale: info) + TranslationHelper.Get("PUNCTUATION", locale: info) + TranslationHelper.Get("SYMBOLS", locale: info) + "\n" + TranslationHelper.Get("DIVIDE", locale: info)));
            //-----------------//
